...
const Header = () => {
  ...
  const [isSun, setIsSun] = useState(true); // Estado para alternar entre sol y luna
  ...
  return (
    // <nav class="navbar navbar-expand-lg fixed-top" style={navbarStyle}>
    //   <div class="container">
    ...
    //         <li class="nav-item">
    //           <a class="nav-link" aria-current="page" href="#" style={{ color: navbarStyle.color }}>Home</a>
    //         </li>
    //         <li class="nav-item">
    //           <a class="nav-link" href="#" style={{ color: navbarStyle.color }}>Heroes</a>
    //         </li>
    //         <li class="nav-item">
    //           <a class="nav-link" href="#" style={{ color: navbarStyle.color }}>Villains</a>
    //         </li>
    //         <li class="nav-item">
    //           <a class="nav-link" href="#" style={{ color: navbarStyle.color }}>About</a>
    //         </li>
    //       </ul>
    //       <form role="search">
    ...
    //       <div class="sun rounded" onClick={toggleIcon}> 
